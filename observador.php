...
<body>
    <nav class="navbar navbar-expand-lg navbar-info bg-info">
        <div class="container-fluid">
            <a><i class="fas fa-user size-icons-sign mx-3"></i><?php echo $_SESSION['usuario'] ?> - Observador</a>
